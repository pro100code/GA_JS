...
console.log('Чистый месячный доход: ', expensesAmount);
...
let getAccumulatedMonth = function(){
	let cleanMoney;
	cleanMoney = money - expensesAmount;
	if(cleanMoney > 0) {
...
console.log('Чистый доход: ', accumulatedMonth);
...
let budgetDay = expensesAmount / 30;
